...
int no_automata = 1;
 public int exprIndex =RegExpHolder .parseAndStore ("[p] (ADMIN_reconcile[0,0.5])*;");
...
currentState =-1 ;
		...
		else if ((_occurredEvent(_event,0/*evt_ADMIN_reconcile*/)) && (reh .toDerivative (Sym_ADMIN_reconcile ).isEmpty ())){
		reh .stop ();
