...
_cls_script_30 _cls_inst = _cls_script_30._get_cls_script_30_inst();
_cls_inst._call(thisJoinPoint.getSignature().toString(), 0/*evt_ADMIN_reconcile*/);
_cls_inst._call_all_filtered(thisJoinPoint.getSignature().toString(), 0/*evt_ADMIN_reconcile*/);
}
}
