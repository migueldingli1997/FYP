...
int no_automata = 0;
 public int exprIndex =RegExpHolder .parseAndStore ("typedef ui : transactionsystem.UserInfo; typedef ua : transactionsystem.UserAccount; [p] deposit(ui,ua).ADMIN_initialise.openSession(ui).withdraw(ui,ua);");
 ...
 public Symbol Sym_openSession_ui =new Symbol ("openSession",Arrays .asList ("ui"));
