...
_cls_script_20 _cls_inst = _cls_script_20._get_cls_script_20_inst();
_cls_inst._call(thisJoinPoint.getSignature().toString(), 4/*evt_ADMIN_reconcile*/, 6/*evt_anySymbol*/);
_cls_inst._call_all_filtered(thisJoinPoint.getSignature().toString(), 4/*evt_ADMIN_reconcile*/, 6/*evt_anySymbol*/);
}
}
...
_cls_script_20 _cls_inst = _cls_script_20._get_cls_script_20_inst();
_cls_inst._call(thisJoinPoint.getSignature().toString(), 2/*evt_ADMIN_createUser*/, 6/*evt_anySymbol*/);
_cls_inst._call_all_filtered(thisJoinPoint.getSignature().toString(), 2/*evt_ADMIN_createUser*/, 6/*evt_anySymbol*/);
}
}
