...
if (0==1){}
		...
		else if ((_occurredEvent(_event,16/*evt_channelStateSkip*/)) && (ss .getDestination ().equals ("main_to_start"))){
...
_killThis ();
		...
		else if ((_occurredEvent(_event,15/*evt_anyTimeout*/))){
...
_killThis ();
		...
		if (1==0){}
		else if ((_occurredEvent(_event,6/*evt_withdraw_ua*/)) && (clock_0 .current ()>=2 &&clock_0 .current ()<4 )){
		clock_0 .pause ();
