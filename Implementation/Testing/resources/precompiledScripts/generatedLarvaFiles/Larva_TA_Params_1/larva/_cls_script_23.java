...
public class _cls_script_23 implements _callable{

public static LinkedHashMap<_cls_script_23,_cls_script_23> _cls_script_23_instances = new LinkedHashMap<_cls_script_23,_cls_script_23>();

_cls_script_22 parent;
...
public _cls_script_23( AutomatonInstance ta,UserAccount _ua,UserInfo _ui) {
parent = _cls_script_22._get_cls_script_22_inst( _ua,_ui);
this.ta = ta;
}
...
public static _cls_script_23 _get_cls_script_23_inst( AutomatonInstance ta,UserAccount _ua,UserInfo _ui) { synchronized(_cls_script_23_instances){
_cls_script_23 _inst = new _cls_script_23( ta,_ua,_ui);
if (_cls_script_23_instances.containsKey(_inst))
{
_cls_script_23 tmp = _cls_script_23_instances.get(_inst);
 return _cls_script_23_instances.get(_inst);
}
else
{
 _cls_script_23_instances.put(_inst,_inst);
...
public boolean equals(Object o) {
 if ((o instanceof _cls_script_23)
 && (ta == null || ta.equals(((_cls_script_23)o).ta))
 && (parent == null || parent.equals(((_cls_script_23)o).parent)))
{return true;}
else
{return false;}
}
...
synchronized(_cls_script_23_instances){
...
_cls_script_23[] a = new _cls_script_23[1];
synchronized(_cls_script_23_instances){
a = _cls_script_23_instances.keySet().toArray(a);}
for (_cls_script_23 _inst : a)
...
if (--no_automata == 0){
synchronized(_cls_script_23_instances){
_cls_script_23_instances.remove(this);}
}
...
if (0==1){}
		...
		if (1==0){}
		else if ((_occurredEvent(_event,4/*evt_deposit_ui_ua*/))){
