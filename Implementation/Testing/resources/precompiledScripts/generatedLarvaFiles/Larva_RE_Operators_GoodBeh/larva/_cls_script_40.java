...
int no_automata = 1;
 public int exprIndex =RegExpHolder .parseAndStore ("[p] ADMIN_createUser*; {ADMIN_reconcile}");
...
currentState =-1 ;
		...
		else if ((_occurredEvent(_event,0/*evt_ADMIN_createUser*/)) && (reh .toDerivative (Sym_ADMIN_createUser ).isEmpty ())){
		reh .stop ();
