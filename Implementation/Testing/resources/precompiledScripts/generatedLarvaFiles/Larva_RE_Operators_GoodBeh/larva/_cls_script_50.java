...
int no_automata = 1;
 public int exprIndex =RegExpHolder .parseAndStore ("[p] ADMIN_initialise[2,4];");
...
reh =new RegExpHolder (exprIndex );
		...
		if (1==0){}
		else if ((_occurredEvent(_event,2/*timeout_isE*/)) && (reh .getId ()==id )){
		reh .stop ();
...
case 0: if (_mode == 0) return "bad"; else return "!!!SYSTEM REACHED BAD STATE!!! bad "+new _BadStateExceptionscript_5().toString()+" ";
