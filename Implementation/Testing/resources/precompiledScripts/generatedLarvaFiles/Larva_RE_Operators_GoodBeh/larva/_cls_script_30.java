...
int no_automata = 1;
 public int exprIndex =RegExpHolder .parseAndStore ("[p] ADMIN_initialise & ~ADMIN_reconcile; {ADMIN_createUser}");
...
currentState =-1 ;
		...
		else if ((_occurredEvent(_event,4/*evt_ADMIN_createUser*/)) && (reh .toDerivative (Sym_ADMIN_createUser ).isEmpty ())){
		reh .stop ();
