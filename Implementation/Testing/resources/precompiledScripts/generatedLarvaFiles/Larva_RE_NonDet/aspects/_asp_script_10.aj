...
_cls_script_10 _cls_inst = _cls_script_10._get_cls_script_10_inst();
_cls_inst.__0 = __0;
_cls_inst._call(thisJoinPoint.getSignature().toString(), 14/*evt_LarvaReset*/);
_cls_inst._call_all_filtered(thisJoinPoint.getSignature().toString(), 14/*evt_LarvaReset*/);
}
}
...
_cls_script_10 _cls_inst = _cls_script_10._get_cls_script_10_inst();
_cls_inst.__1 = __1;
_cls_inst._call(thisJoinPoint.getSignature().toString(), 16/*evt_LarvaStop*/);
_cls_inst._call_all_filtered(thisJoinPoint.getSignature().toString(), 16/*evt_LarvaStop*/);
}
}
}