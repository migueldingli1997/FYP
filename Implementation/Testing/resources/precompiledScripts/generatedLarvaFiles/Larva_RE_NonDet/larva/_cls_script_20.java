...
int no_automata = 1;
 public int exprIndex =RegExpHolder .parseAndStore ("[n] makeGoldUser.( openSession.deposit + openSession.withdraw) + makeGoldUser.(closeSession.deposit + closeSession.withdraw) + makeSilverUser;");
 public Symbol Sym_makeGoldUser =new Symbol ("makeGoldUser");
 public Symbol Sym_openSession =new Symbol ("openSession");
 public Symbol Sym_deposit =new Symbol ("deposit");
 public Symbol Sym_withdraw =new Symbol ("withdraw");
 public Symbol Sym_closeSession =new Symbol ("closeSession");
 public Symbol Sym_makeSilverUser =new Symbol ("makeSilverUser");
...
if (0==1){}
		...
		if (1==0){}
		else if ((_occurredEvent(_event,16/*evt_LarvaReset*/))){
...
reh =new RegExpHolder (exprIndex );
		...
		if (1==0){}
		else if ((_occurredEvent(_event,18/*evt_LarvaStop*/))){
		reh .stop ();
		...
		if (1==0){}
		else if ((_occurredEvent(_event,14/*timeout_hasE*/)) && (reh .getId ()==id )){
		reh .stop ();
...
currentState =-1 ;
		...
		else if ((_occurredEvent(_event,12/*timeout_isE*/)) && (reh .getId ()==id )){
		reh .stop ();
...
currentState =1 ;
		...
		else if ((_occurredEvent(_event,0/*evt_makeGoldUser*/)) && (reh .toDerivative (Sym_makeGoldUser ).hasEmptyString ())){
		reh .stop ();
...
currentState =-1 ;
		...
		else if ((_occurredEvent(_event,2/*evt_openSession*/)) && (reh .toDerivative (Sym_openSession ).hasEmptyString ())){
		reh .stop ();
...
currentState =-1 ;
		...
		else if ((_occurredEvent(_event,4/*evt_deposit*/)) && (reh .toDerivative (Sym_deposit ).hasEmptyString ())){
		reh .stop ();
...
currentState =-1 ;
		...
		else if ((_occurredEvent(_event,6/*evt_withdraw*/)) && (reh .toDerivative (Sym_withdraw ).hasEmptyString ())){
		reh .stop ();
...
currentState =-1 ;
		...
		else if ((_occurredEvent(_event,8/*evt_closeSession*/)) && (reh .toDerivative (Sym_closeSession ).hasEmptyString ())){
		reh .stop ();
...
currentState =-1 ;
		...
		else if ((_occurredEvent(_event,10/*evt_makeSilverUser*/)) && (reh .toDerivative (Sym_makeSilverUser ).hasEmptyString ())){
		reh .stop ();
...
currentState =-1 ;
		...
		else if ((_occurredEvent(_event,0/*evt_makeGoldUser*/)) && (reh .getRegExp ().isEmpty ())){
		reh .stop ();
...
currentState =1 ;
		...
		else if ((_occurredEvent(_event,2/*evt_openSession*/)) && (reh .getRegExp ().isEmpty ())){
		reh .stop ();
...
currentState =1 ;
		...
		else if ((_occurredEvent(_event,4/*evt_deposit*/)) && (reh .getRegExp ().isEmpty ())){
		reh .stop ();
...
currentState =1 ;
		...
		else if ((_occurredEvent(_event,6/*evt_withdraw*/)) && (reh .getRegExp ().isEmpty ())){
		reh .stop ();
...
currentState =1 ;
		...
		else if ((_occurredEvent(_event,8/*evt_closeSession*/)) && (reh .getRegExp ().isEmpty ())){
		reh .stop ();
...
currentState =1 ;
		...
		else if ((_occurredEvent(_event,10/*evt_makeSilverUser*/)) && (reh .getRegExp ().isEmpty ())){
		reh .stop ();
