...
if (0==1){}
		...
		if (1==0){}
		else if ((_occurredEvent(_event,9/*evt_LarvaReset*/))){
...
channel_stateSkip .send (new StateSkip (new AutomatonInstance (true ,true ),"main_to_start"));
		...
		if (1==0){}
		else if ((_occurredEvent(_event,11/*evt_LarvaStop*/))){
		instanceCount =0 ;
		...
		if (1==0){}
		else if ((_occurredEvent(_event,7/*evt_channelTAsToMain*/)) && (state .equals ("bad"))){
...
currentState =-1 ;
		...
		else if ((_occurredEvent(_event,7/*evt_channelTAsToMain*/)) && (state .equals ("good")&&--instanceCount ==0 )){
