...
_cls_script_40 _cls_inst = _cls_script_40._get_cls_script_40_inst();
_cls_inst._call(thisJoinPoint.getSignature().toString(), 0/*evt_ADMIN_createUser*/, 4/*evt_anySymbol*/);
_cls_inst._call_all_filtered(thisJoinPoint.getSignature().toString(), 0/*evt_ADMIN_createUser*/, 4/*evt_anySymbol*/);
}
}
