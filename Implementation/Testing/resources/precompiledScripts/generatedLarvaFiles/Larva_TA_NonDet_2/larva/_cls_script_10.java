...
if (0==1){}
		...
		if (1==0){}
		else if ((_occurredEvent(_event,13/*evt_LarvaReset*/))){
...
channel_stateSkip .send (new StateSkip (new AutomatonInstance (true ,true ),"main_to_start"));
		...
		if (1==0){}
		else if ((_occurredEvent(_event,15/*evt_LarvaStop*/))){
		instanceCount =0 ;
		...
		if (1==0){}
		else if ((_occurredEvent(_event,11/*evt_channelTAsToMain*/)) && (state .equals ("bad")&&--instanceCount ==0 )){
