...
if (0==1){}
		...
		_state_id_property = 23;//moving to state bad
...
_killThis ();
		...
		_state_id_property = 24;//moving to state good
parent.channel_TAsToMain .send (new Outcome ("good"));
_killThis ();
...
_killThis ();
		...
		_state_id_property = 22;//moving to state S10
if (true ){parent.instanceCount ++;
...
_killThis ();
		...
		_state_id_property = 21;//moving to state S8
if (true ){parent.instanceCount ++;
...
_killThis ();
		...
		_state_id_property = 16;//moving to state S15
		_goto_property(_info);
		}
		else if ((_occurredEvent(_event,12/*evt_anySymbol*/))){
...
_killThis ();
		...
		_state_id_property = 20;//moving to state S1
if (true ){parent.instanceCount ++;
...
case 10: if (_mode == 0) return "S7"; else return "S7";
case 23: if (_mode == 0) return "bad"; else return "bad";
case 21: if (_mode == 0) return "S8"; else return "S8";
case 11: if (_mode == 0) return "S9"; else return "S9";
case 25: if (_mode == 0) return "start"; else return "start";
case 24: if (_mode == 0) return "good"; else return "good";
case 12: if (_mode == 0) return "S11"; else return "S11";
case 22: if (_mode == 0) return "S10"; else return "S10";
case 14: if (_mode == 0) return "S13"; else return "S13";
case 13: if (_mode == 0) return "S12"; else return "S12";
case 16: if (_mode == 0) return "S15"; else return "S15";
case 15: if (_mode == 0) return "S14"; else return "S14";
case 18: if (_mode == 0) return "S17"; else return "S17";
case 17: if (_mode == 0) return "S16"; else return "S16";
case 19: if (_mode == 0) return "S18"; else return "S18";
case 4: if (_mode == 0) return "S0"; else return "S0";
case 20: if (_mode == 0) return "S1"; else return "S1";
