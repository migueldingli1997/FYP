...
_cls_script_61[] a1 = new _cls_script_61[1];
synchronized(_cls_script_61._cls_script_61_instances){
a1 = _cls_script_61._cls_script_61_instances.keySet().toArray(a1);}
for (_cls_script_61 _inst : a1)
if (_inst != null){
...
_cls_script_60.pw.println("[main]MOVED ON METHODCALL: "+ _info +" TO STATE::> " + state_format);
