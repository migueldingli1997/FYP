...
_cls_script_71[] a1 = new _cls_script_71[1];
synchronized(_cls_script_71._cls_script_71_instances){
a1 = _cls_script_71._cls_script_71_instances.keySet().toArray(a1);}
for (_cls_script_71 _inst : a1)
if (_inst != null){
...
_cls_script_70.pw.println("[main]MOVED ON METHODCALL: "+ _info +" TO STATE::> " + state_format);
