...
public class _cls_script_71 implements _callable{

public static LinkedHashMap<_cls_script_71,_cls_script_71> _cls_script_71_instances = new LinkedHashMap<_cls_script_71,_cls_script_71>();

_cls_script_70 parent;
...
public _cls_script_71( AutomatonInstance ta) {
parent = _cls_script_70._get_cls_script_70_inst();
this.ta = ta;
}
...
public static _cls_script_71 _get_cls_script_71_inst( AutomatonInstance ta) { synchronized(_cls_script_71_instances){
_cls_script_71 _inst = new _cls_script_71( ta);
if (_cls_script_71_instances.containsKey(_inst))
{
_cls_script_71 tmp = _cls_script_71_instances.get(_inst);
 return _cls_script_71_instances.get(_inst);
}
else
{
 _cls_script_71_instances.put(_inst,_inst);
...
public boolean equals(Object o) {
 if ((o instanceof _cls_script_71)
 && (ta == null || ta.equals(((_cls_script_71)o).ta))
 && (parent == null || parent.equals(((_cls_script_71)o).parent)))
{return true;}
else
{return false;}
}
...
synchronized(_cls_script_71_instances){
...
_cls_script_71[] a = new _cls_script_71[1];
synchronized(_cls_script_71_instances){
a = _cls_script_71_instances.keySet().toArray(a);}
for (_cls_script_71 _inst : a)
...
if (--no_automata == 0){
synchronized(_cls_script_71_instances){
_cls_script_71_instances.remove(this);}
}
...
if (0==1){}
		...
		if (1==0){}
		else if ((_occurredEvent(_event,0/*evt_ADMIN_reconcile*/))){
