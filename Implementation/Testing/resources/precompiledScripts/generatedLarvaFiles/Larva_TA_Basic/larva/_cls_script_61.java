...
public class _cls_script_61 implements _callable{

public static LinkedHashMap<_cls_script_61,_cls_script_61> _cls_script_61_instances = new LinkedHashMap<_cls_script_61,_cls_script_61>();

_cls_script_60 parent;
...
public _cls_script_61( AutomatonInstance ta) {
parent = _cls_script_60._get_cls_script_60_inst();
this.ta = ta;
}
...
public static _cls_script_61 _get_cls_script_61_inst( AutomatonInstance ta) { synchronized(_cls_script_61_instances){
_cls_script_61 _inst = new _cls_script_61( ta);
if (_cls_script_61_instances.containsKey(_inst))
{
_cls_script_61 tmp = _cls_script_61_instances.get(_inst);
 return _cls_script_61_instances.get(_inst);
}
else
{
 _cls_script_61_instances.put(_inst,_inst);
...
public boolean equals(Object o) {
 if ((o instanceof _cls_script_61)
 && (ta == null || ta.equals(((_cls_script_61)o).ta))
 && (parent == null || parent.equals(((_cls_script_61)o).parent)))
{return true;}
else
{return false;}
}
...
synchronized(_cls_script_61_instances){
...
_cls_script_61[] a = new _cls_script_61[1];
synchronized(_cls_script_61_instances){
a = _cls_script_61_instances.keySet().toArray(a);}
for (_cls_script_61 _inst : a)
...
if (--no_automata == 0){
synchronized(_cls_script_61_instances){
_cls_script_61_instances.remove(this);}
}
