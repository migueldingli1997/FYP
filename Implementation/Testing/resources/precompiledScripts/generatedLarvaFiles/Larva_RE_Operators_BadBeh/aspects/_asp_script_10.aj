...
_cls_script_10 _cls_inst = _cls_script_10._get_cls_script_10_inst();
_cls_inst._call(thisJoinPoint.getSignature().toString(), 4/*evt_ADMIN_reconcile*/);
_cls_inst._call_all_filtered(thisJoinPoint.getSignature().toString(), 4/*evt_ADMIN_reconcile*/);
}
}
...
_cls_script_10 _cls_inst = _cls_script_10._get_cls_script_10_inst();
_cls_inst._call(thisJoinPoint.getSignature().toString(), 2/*evt_ADMIN_createUser*/);
_cls_inst._call_all_filtered(thisJoinPoint.getSignature().toString(), 2/*evt_ADMIN_createUser*/);
}
}
