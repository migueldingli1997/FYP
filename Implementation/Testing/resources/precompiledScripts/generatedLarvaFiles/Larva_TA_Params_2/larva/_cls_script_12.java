...
_cls_script_13[] a3 = new _cls_script_13[1];
synchronized(_cls_script_13._cls_script_13_instances){
a3 = _cls_script_13._cls_script_13_instances.keySet().toArray(a3);}
for (_cls_script_13 _inst : a3)
if (_inst != null
...
if (0==1){}
		...
		if (1==0){}
		else if ((_occurredEvent(_event,3/*evt_LarvaReset*/))){
...
channel_stateSkip .send (new StateSkip (new AutomatonInstance (true ,true ),"main_to_start",new Object []{parent._ui ,_ua }));
		...
		if (1==0){}
		else if ((_occurredEvent(_event,5/*evt_LarvaStop*/))){
		instanceCount =0 ;
