...
public class _cls_script_13 implements _callable{

public static LinkedHashMap<_cls_script_13,_cls_script_13> _cls_script_13_instances = new LinkedHashMap<_cls_script_13,_cls_script_13>();

_cls_script_12 parent;
...
public static _cls_script_13 _get_cls_script_13_inst( AutomatonInstance ta,UserAccount _ua,UserInfo _ui) { synchronized(_cls_script_13_instances){
_cls_script_13 _inst = new _cls_script_13( ta,_ua,_ui);
if (_cls_script_13_instances.containsKey(_inst))
{
_cls_script_13 tmp = _cls_script_13_instances.get(_inst);
 return _cls_script_13_instances.get(_inst);
}
else
{
 _cls_script_13_instances.put(_inst,_inst);
...
public boolean equals(Object o) {
 if ((o instanceof _cls_script_13)
 && (ta == null || ta.equals(((_cls_script_13)o).ta))
 && (parent == null || parent.equals(((_cls_script_13)o).parent)))
{return true;}
else
{return false;}
}
...
synchronized(_cls_script_13_instances){
...
_cls_script_13[] a = new _cls_script_13[1];
synchronized(_cls_script_13_instances){
a = _cls_script_13_instances.keySet().toArray(a);}
for (_cls_script_13 _inst : a)
...
if (--no_automata == 0){
synchronized(_cls_script_13_instances){
_cls_script_13_instances.remove(this);}
}
...
parent.channel_TAsToMain .send (new Outcome ("bad",new Object []{parent.parent._ui ,parent._ua }));
_killThis ();

		_goto_property(_info);
		}
		else if ((_occurredEvent(_event,9/*evt_anySymbol_ui*/))){
...
_killThis ();
		...
		else if ((_occurredEvent(_event,14/*evt_anySymbol_ua*/))){
...
_killThis ();
		...
		if (1==0){}
		else if ((_occurredEvent(_event,10/*evt_deposit_ui_ua*/))){
...
_killThis ();
		...
		if (1==0){}
		else if ((_occurredEvent(_event,7/*evt_openSession_ui*/))){
...
_killThis ();
		...
		if (1==0){}
		else if ((_occurredEvent(_event,12/*evt_withdraw_ui_ua*/))){
