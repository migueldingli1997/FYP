...
public class TA_basic {
    ...
    public void tearDown() {
        ...
        new LinkedHashMap<>(_cls_script_31._cls_script_31_instances).forEach((k, v) -> k._killThis());
        new LinkedHashMap<>(_cls_script_41._cls_script_41_instances).forEach((k, v) -> k._killThis());
        new LinkedHashMap<>(_cls_script_51._cls_script_51_instances).forEach((k, v) -> k._killThis());
        new LinkedHashMap<>(_cls_script_61._cls_script_61_instances).forEach((k, v) -> k._killThis());
        new LinkedHashMap<>(_cls_script_71._cls_script_71_instances).forEach((k, v) -> k._killThis());
