...
int no_automata = 0;
 public int exprIndex =RegExpHolder .parseAndStore ("typedef cH: com.guichaguri.minimalftp.handler.ConnectionHandler; [n] syst(cH) + stat(cH) + mode(cH) + pasv(cH) + port(cH); {authenticate(cH)}");
 public Symbol Sym_syst_cH =new Symbol ("syst",Arrays .asList ("cH"));
 public Symbol Sym_stat_cH =new Symbol ("stat",Arrays .asList ("cH"));
 public Symbol Sym_mode_cH =new Symbol ("mode",Arrays .asList ("cH"));
 public Symbol Sym_pasv_cH =new Symbol ("pasv",Arrays .asList ("cH"));
 public Symbol Sym_port_cH =new Symbol ("port",Arrays .asList ("cH"));
